...
public class ExportExcelUtils {
  ...
  public static <T> void export(
      String excelName, List<T> list, Map<String, String> fieldMap, HttpServletResponse response) {
    ...
    try {
      response.setHeader(
          "Content-disposition",
          "attachment; filename=" + new String(excelName.getBytes("UTF-8")) + ".xls");
   ...
   * @throws Exception 異常
   */
  public static Object getFieldValueByNameSequence(String fieldNameSequence, Object o)
      throws Exception {
    Object value = null;
  ...
  public static <T> void fillSheet(
      HSSFSheet sheet, List<T> list, Map<String, String> fieldMap, HSSFCellStyle style)
      throws Exception {

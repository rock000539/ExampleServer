...
/**
 * Provides a simple SQL template for <code>Apache Hive</code> database.
 *
 * @author Allen Lin
 * @since 1.0.0
 */
@ConditionalOnSingleCandidate(HivSqlTemplate.class)
@Component
public class HivSqlTemplate extends SqlTemplate {
	...
	public String formatPaginateSql(String sql, Pageable pageable) {
		throw new UnsupportedOperationException("Unsupported format pagination in hiv db");
	}

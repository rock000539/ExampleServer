...
/**
 * Provides a simple SQL template for <code>Apache Derby</code> database.
 *
 * @author Allen Lin
 * @since 1.0.0
 */
@ConditionalOnSingleCandidate(DerbySqlTemplate.class)
@Component
public class DerbySqlTemplate extends SqlTemplate {
	...
	public String formatPaginateSql(String sql, Pageable pageable) {
		throw new UnsupportedOperationException("Unsupported format pagination in derby db");
	}

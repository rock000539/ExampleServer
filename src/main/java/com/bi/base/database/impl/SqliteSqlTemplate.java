...
/**
 * Provides a simple SQL template for <code>SQLite</code> database.
 *
 * @author Allen Lin
 * @since 1.0.0
 */
@ConditionalOnSingleCandidate(SqliteSqlTemplate.class)
@Component
public class SqliteSqlTemplate extends SqlTemplate {
	...
	public String formatPaginateSql(String sql, Pageable pageable) {
		throw new UnsupportedOperationException("Unsupported format pagination in sqlite db");
	}

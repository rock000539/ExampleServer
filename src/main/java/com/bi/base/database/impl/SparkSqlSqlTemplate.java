...
/**
 * Provides a simple SQL template for <code>Apache Spark</code> database.
 *
 * @author Allen Lin
 * @since 1.0.0
 */
@ConditionalOnSingleCandidate(SparkSqlSqlTemplate.class)
@Component
public class SparkSqlSqlTemplate extends SqlTemplate {
	...
	public String formatPaginateSql(String sql, Pageable pageable) {
		throw new UnsupportedOperationException("Unsupported format pagination in sparkSql db");
	}

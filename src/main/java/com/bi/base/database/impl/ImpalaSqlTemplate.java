...
/**
 * Provides a simple SQL template for <code>Apache Impala</code> database.
 *
 * @author Allen Lin
 * @since 1.0.0
 */
@ConditionalOnSingleCandidate(ImpalaSqlTemplate.class)
@Component
public class ImpalaSqlTemplate extends SqlTemplate {
	...
	public String formatPaginateSql(String sql, Pageable pageable) {
		throw new UnsupportedOperationException("Unsupported format pagination in impala db");
	}

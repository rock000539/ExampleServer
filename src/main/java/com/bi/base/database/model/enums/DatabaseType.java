...
public enum DatabaseType {
	...
	public AbstractColumnMaxValueIncrementer getColumnMaxValueIncrementer(String incrementerName, String columnName) {
		...
		if (log.isDebugEnabled())
			log.debug("ColumnMaxValueIncrementer name/column: {}", columnMaxValueIncrementer.getIncrementerName().concat("/").concat(columnMaxValueIncrementer.getColumnName()));
	...
	public AbstractSequenceMaxValueIncrementer getSequenceMaxValueIncrementer(String incrementerName) {
		...
		if (log.isDebugEnabled())
			log.debug("SequenceMaxValueIncrementer: {}", sequenceMaxValueIncrementer.getIncrementerName());
